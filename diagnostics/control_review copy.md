...
```json
{
  ...
  "population": {
    ...
    "steps": [
      ...
      {
        "step_id": "filter_ofac_matches",
        "action": {
          "operation": "filter_is_null",
          "field": "ofac_watch_list_sheet1.tax_id",
          "is_null": false
        }
      },
      {
  ...
  "assertions": [
    ...
    },
    {
      ...
      "description": "High-risk customers must have an EDD completion date recorded",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "edd_tracker_sheet1.edd_completion_date",
      "operator": "neq",
      "expected_value": null,
      "ignore_case_and_space": true
    },
    {
      ...
      "description": "EDD completion must occur within 14 days of onboarding for high-risk customers",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "temporal_date_math",
      "base_date_field": "edd_tracker_sheet1.edd_completion_date",
      "operator": "lte",
...
SELECT *
FROM join_edd
WHERE (tax_id IS NOT NULL AND risk_rating = 'HIGH') 
  AND (NOT (tax_id IS NULL) OR NOT (edd_completion_date IS NOT NULL) OR NOT (CAST(edd_completion_date AS DATE) <= CAST(onboarding_date AS DATE) + INTERVAL 14 DAY))
```
...
```json
{
  "governance": {
    ...
    "risk_objective": "Ensure adequate segregation and funding of Client Money accounts to avoid penalties and license loss"
  },
  "ontology_bindings": [
    {
  ...
  "assertions": [
    {
      "assertion_id": "agg_minimum_buffer",
      "description": "Verify aggregated SUM of current_balance grouped by calculation_date is >= $50,000,000",
      "materiality_threshold_percent": 0.0,
...
HAVING NOT (SUM(current_balance) >= 50000000.0)
```
...
```json
{
  ...
  "assertions": [
    {
      ...
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "service_tickets_sheet1.ticket_status",
      "operator": "eq",
    ...
    {
      "assertion_id": "assertion_2",
      "description": "Verify that the ticket closed_date occurred on or before the termination_date plus 1 day",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "temporal_date_math",
      "base_date_field": "service_tickets_sheet1.closed_date",
      "operator": "lte",
      "target_date_field": "hr_terminations_sheet1.termination_date",
      "offset_days": 1
    },
    {
      "assertion_id": "assertion_3",
      "description": "Verify that the employee does NOT exist in the Tier 1 application (system_accounts employee_id IS NULL)",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "system_accounts_sheet1.employee_id",
      "operator": "eq",
      "expected_value": null,
      "ignore_case_and_space": true
    }
  ...
  "evidence": {
    "retention_years": 7,
    "reviewer_workflow": "Requires_Human_Signoff",
    "exception_routing_queue": "IAM Security Exceptions"
  }
}
```
...
WHERE (termination_type IN ('VOLUNTARY', 'INVOLUNTARY')) 
  AND (NOT (TRIM(UPPER(CAST(ticket_status AS VARCHAR))) = TRIM(UPPER('CLOSED'))) OR NOT (CAST(closed_date AS DATE) <= CAST(termination_date AS DATE) + INTERVAL 1 DAY) OR NOT (employee_id IS NULL))
```
...
```json
{
  ...
  "population": {
    ...
    "steps": [
      ...
      {
        "step_id": "filter_non_null_hr_status",
        "action": {
          "operation": "filter_is_null",
          "field": "hr_master_roster_sheet1.employment_status",
          "is_null": false
        }
      }
    ],
  ...
  "assertions": [
    {
      "assertion_id": "assertion_1",
      "description": "Verify that HR employment status is not 'TERMINATED' for active AD accounts",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "hr_master_roster_sheet1.employment_status",
      "operator": "neq",
  ...
  "evidence": {
    "retention_years": 7,
    "reviewer_workflow": "Requires_Human_Signoff",
    "exception_routing_queue": "ITGC_Access_Exceptions"
  }
}
```
...
SELECT *
FROM join_hr_data
WHERE (account_status = 'ACTIVE' AND employment_status IS NOT NULL) 
  AND (NOT (TRIM(UPPER(CAST(employment_status AS VARCHAR))) != TRIM(UPPER('TERMINATED'))))
```
...
```json
{
  ...
  "population": {
    ...
    "steps": [
      ...
      {
        "step_id": "filter_matched_restrictions",
        "action": {
          "operation": "filter_is_null",
  ...
  "assertions": [
    {
      "assertion_id": "assertion_1",
      "description": "Check that restriction status is 'CLEARED' for matched trades",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
    ...
    {
      "assertion_id": "assertion_2",
      "description": "Check that trade date is after clearance date",
      "materiality_threshold_percent": 0.0,
  ...
  "evidence": {
    "retention_years": 7,
    "reviewer_workflow": "Requires_Human_Signoff",
    "exception_routing_queue": "Insider_Trading_Exceptions"
  }
}
```
...
WHERE (employee_id IS NOT NULL) 
  AND (NOT (TRIM(UPPER(CAST(restriction_status AS VARCHAR))) = TRIM(UPPER('CLEARED'))) OR NOT (trade_date > clearance_date))
```
...
```json
{
  ...
  "assertions": [
    {
      "assertion_id": "assertion_1",
      "description": "Verify settlement_date occurred on or before trade_date plus 2 days",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "temporal_date_math",
...
WHERE (trade_status = 'SETTLED') 
  AND (NOT (CAST(settlement_date AS DATE) <= CAST(trade_date AS DATE) + INTERVAL 2 DAY))
```
  ...
  "assertions": [
    {
      ...
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "employee_titles_sheet1.approver_title",
      "operator": "in",
      "expected_value": [
        "SVP",
        "EVP",
...
WHERE (invoice_amount > 100000) 
  AND (NOT (approver_title IN ('SVP', 'EVP', 'CEO', 'CFO')))
```
  ...
  "assertions": [
    {
      ...
      "description": "Buyer account ID must not equal seller account ID to prevent wash trading",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "column_comparison",
...
WHERE (status = 'EXECUTED') 
  AND (NOT (buyer_account_id != seller_account_id))
```
...
```json
{
  "governance": {
    ...
    "risk_objective": "Prevent utilization of critical third-party vendors with inadequate security controls"
  },
  "ontology_bindings": [
    {
  ...
  "population": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "action": {
          "operation": "filter_comparison",
          "field": "vendor_master_sheet1.criticality",
          "operator": "eq",
          "value": "TIER_1"
        }
      },
      ...
      {
        "step_id": "filter_non_null_assessments",
        "action": {
          "operation": "filter_is_null",
          "field": "security_assessments_sheet1.assessment_status",
          "is_null": false
        }
      }
    ],
  ...
  "assertions": [
    {
      "assertion_id": "assertion_1",
      "description": "Verify most recent assessment status is PASSED",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "value_match",
      "field": "security_assessments_sheet1.assessment_status",
      "operator": "eq",
    ...
    {
      "assertion_id": "assertion_2",
      "description": "Verify security expiration date is after contract renewal date",
      "materiality_threshold_percent": 0.0,
      "assertion_type": "column_comparison",
      "left_field": "security_assessments_sheet1.expiration_date",
      "operator": "gt",
      "right_field": "active_contracts_sheet1.renewal_date"
    }
  ],
  "evidence": {
    "retention_years": 7,
...
WHERE (contract_status = 'ACTIVE' AND criticality = 'TIER_1' AND assessment_status IS NOT NULL) 
  AND (NOT (TRIM(UPPER(CAST(assessment_status AS VARCHAR))) = TRIM(UPPER('PASSED'))) OR NOT (expiration_date > renewal_date))
```
